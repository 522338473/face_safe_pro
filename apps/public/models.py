...
class BaseModel(models.Model):
    ...
    create_by = fields.CharField(null=True, blank=True, max_length=32, verbose_name='创建人')

    detail = fields.CharField(null=True, blank=True, max_length=200, show_word_limit=True, suffix_icon="el-icon-date", verbose_name='备注信息')
