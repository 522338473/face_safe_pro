...
urlpatterns = [
    path('search_person/', csrf_exempt(admin_view.SearchPersonnelView.as_view()), name='search_person'),
    path('access_pass_detail/', csrf_exempt(admin_view.AccessPassDetailView.as_view()), name='access_pass_detail')
]
