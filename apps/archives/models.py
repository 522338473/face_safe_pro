...
class Personnel(BaseModel):
    ...
    archives_group = fields.ForeignKey(
        to="ArchivesGroup",
        null=True,
        blank=True,
    ...
    household_register = fields.CharField(
        null=True,
        blank=True,
        max_length=32,
        show_word_limit=True,
    ...
    date_of_birth = fields.CharField(
        ...
        suffix_icon="el-icon-coffee",
        verbose_name="出生年月",
        placeholder="请输入出生年月: 1900-01-01",
    )
    nation = fields.CharField(
        null=True,
        blank=True,
        max_length=32,
        suffix_icon="el-icon-coffee",
