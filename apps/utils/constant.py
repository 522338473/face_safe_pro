...
TYPES = ((1, "身份证"), (2, "护照"), (3, "港澳居民往来内地通行证"), (4, "其他"))
...
STATUS_CHOICE = ((0, "离线"), (1, "在线"))

DEVICE_TYPE = ((0, "普通相机"), (1, "人脸相机"), (2, "门禁设备"), (3, "无感通行"))

ALARM_TYPE = ((1, "振动报警"), (2, "断纤报警"))

PERSON_TYPES = ((0, "预警人员"), (1, "重点人员"))

VEHICLE_TYPES = ((0, "普通车辆"), (1, "重点车辆"))
