...
class Monitor(BaseModel):
    ...
    photo = fields.ImageField(drag=True, action='/f_upload/monitor/', null=True, blank=True, max_length=128, verbose_name='照片')
...
class ArchivesPersonnel(BaseModel):
    ...
    photo = fields.ImageField(drag=True, action='/f_upload/personnel/', null=True, blank=True, max_length=128, verbose_name='照片')
...
class PhotoCluster(BaseModel):
    ...
    device_head_path = fields.ImageField(drag=True, action='/f_upload/snap/', null=True, blank=True, max_length=64, verbose_name='大头照')
    device_body_path = fields.ImageField(drag=True, action='/f_upload/snap/', null=True, blank=True, max_length=64, verbose_name='全身照')
    device_back_path = fields.ImageField(drag=True, action='/f_upload/snap/', null=True, blank=True, max_length=64, verbose_name='背景照')
