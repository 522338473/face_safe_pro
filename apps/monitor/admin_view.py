...
class PhotoClusterView(ParseJsonView, View):
    ...
    def get(self, request):
        ...
        photo = models.ArchivesPersonnel.objects.get(
    ...
    def post(self, request):
        ...
        _photo_list = (
            models.PhotoCluster.objects.filter(
                archives_personnel_id=self.hash_to_pk(_id)
            )
            .order_by("-id")
            .values()
        )
...
class VehicleSearchView(ParseJsonView, View):
    ...
    def post(self, request):
        ...
        _photo_list = models.VehicleMonitorDiscover.objects.order_by("-id").values(
            "id",
            "target__plate",
            "record__device__name",
            "record__address",
