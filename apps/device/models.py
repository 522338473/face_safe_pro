...
class DeviceInfo(BaseModel):
    ...
    status = fields.IntegerField(
        choices=constant.STATUS_CHOICE, default=1, verbose_name="设备状态"
    )
    ...
    is_access = fields.IntegerField(
        choices=constant.IS_ACCESS, default=0, verbose_name="是否门禁设备"
    )
    device_type = fields.IntegerField(
        choices=constant.DEVICE_TYPE, default=0, verbose_name="设备类型"
    )
...
class DevicePhoto(BaseModel):
    ...
    address = fields.AMapField(
        max_length=128, null=True, blank=True, pick_type="address", verbose_name="抓拍地址"
    )
...
class Vehicle(BaseModel):
    ...
    vehicle_path = fields.ImageField(
        drag=True,
        action="/f_upload/snap/",
        null=True,
        blank=True,
    ...
    panorama_path = fields.ImageField(
        drag=True,
        action="/f_upload/snap/",
        null=True,
        blank=True,
